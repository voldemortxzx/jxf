...
Msg2Player("Sö dông qu¸ nhiÒu ph¸o b«ng liÔu !") 
return 
end 
...
lib:DoFunByPlayer(nPlayerIndex, tbAwardTemplet.GiveAwardByList, tbAwardTemplet, tbData.tbAward,"§èt ph¸o b«ng t­ëng th­ëng ") 

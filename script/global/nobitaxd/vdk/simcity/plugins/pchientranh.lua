...
function createTaskSayChienTranh(mapId, extra)
	...
	if showVoKy == 1 then
		nSettingIdx = 103
		tinsert(tbOpt, 1, "<dec><link=image[0,14]:#npcspr:?NPCSID="..tostring(nSettingIdx).."?ACTION="..tostring(nActionId)..">V� K�:<link> Ng��i H�n lu�n cho r�ng ng��i Kim l� d� man, nh�ng ng��i c� bi�t chi�n tranh b�t ��u t� ��u kh�ng?" .. extra);
	else
		tinsert(tbOpt, 1, "<dec><link=image[8,15]:#npcspr:?NPCSID="..tostring(nSettingIdx).."?ACTION="..tostring(nActionId)..">Tri�u M�n:<link> Ng��i H�n c�c ng��i lu�n cho r�ng ng��i Kim ch�ng ta l� d� man, nh�ng c�c ng��i c� bi�t chi�n tranh b�t ��u t� ��u kh�ng?" .. extra);
	end
...
function SimCityChienTranh:phe_tudo(startNPCIndex, perPage, ngoaitrang)
	...
	-- if (result == 0) then
	-- 	--local tbSay = createTaskSayChienTranh("<enter><enter>Chi�n lo�n t�i b�n �� n�y ch�a ���c m�. Ch�ng c� th� g�i <color=yellow>��a �� ch�<color> ��n t�c gi� tr�n fb h�i qu�n.")
...
function SimCityChienTranh:goiAnhHungThiepNgoaiTrang()
	...
	local extra = "<enter><enter><color=yellow>Nh�n s� hi�n t�i: " .. counter .. "<color>"
...
function SimCityChienTranh:khaiChienPhongHoaLienThanh()	
	...
	SetMissionV(5, 89)
	Say("Qu�n ��ch s� b�t ��u c�ng th�nh trong 20 gi�y, c�c T��ng s� h�y s�n s�ng!")
...
function SimCityChienTranh:khaiChienTongKim()	
	...
	if GetMissionV(1) ~= 2 then			
		AddGlobalCountNews("Th�i gian b�o danh �� k�t th�c. Chi�n ��u ch�nh th�c b�t ��u", 2);
		Msg2Map(self.nW, "Phong V�n Lu�n Ki�m ch�nh th�c khai chi�n! C�c chi�n s�! X�ng l�n!");
		SetMissionV(1,2);

...
SIMBOT_UNIFY_2000 = SIMBOT_UNIFY_2000 or 1  
function SimCityNPCInfo:init()
	if SIMBOT_UNIFY_2000 == 1 then
		self.nvUnified = {}
		for j = 2000, 2023 do tinsert(self.nvUnified, j) end
	end
...
function SimCityNPCInfo:getHPByCap(capHP)
	...
	return random(50000, 80000)
end

function SimCityNPCInfo:getPoolByCap(capHP)
	if SIMBOT_UNIFY_2000 == 1 and self.nvUnified then return self.nvUnified end   

...
SIM_SAY_REPLY = {[0]="rep_chung",[1]="rep_ok",[2]="rep_no",[3]="rep_chao",[4]="rep_giaodich",[5]="rep_boss"}  -- [2026-06-21] category tu C -> type trong chat.txt

function execChat(tbNpc, isKeoXe) 
    -- [CHAT REPLY 2026-06-21] player noi gan -> bot nay reply theo keyword (category do C tra ve)
    if HasPlayerSay and HasPlayerSay() == 1 and tbNpc.finalIndex and tbNpc.finalIndex > 0 then

...
g_TK_BangRanks = g_TK_BangRanks or { "Bang Ch�", "Tr��ng l�o", "���ng Ch�", "�� T�" }   -- Bang Chu/Truong Lao/Duong Chu/De Tu
g_TK_BangNames = g_TK_BangNames or {
	"AnhEm", "B�Gi�", "Th�chPK", "Ph�Thi�n", "Thi�n��a",
	"T�nh", "Ti�uNg�o", "Badboy", "Huynh��", "S�t",
}

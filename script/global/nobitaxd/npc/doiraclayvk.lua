...
function weapon_ring()
	...
	Say("GÇn ®©y vò khİ quı trªn giang hå hiÕm, ta nh©n c¬ héi ®i häc ph­¬ng ph¸p lµm vò khİ, chØ cÇn ng­¬i chuÈn bŞ mét bé vô khİ cã ®ñ 5 thuéc tİnh ngò hµnh vµ 10 v¹n l­îng, ta sÏ gióp ®æi mét vò khİ thuéc tİnh mµu xanh, ng­¬i muèn ®æi kh«ng?",3,"§­îc, ta ®ang cÇn mét mãn vò khİ ®©y!/exchange_weapon","§Ó ta t×m hiÓu c¸i ®·!/weapon_help","Th«i bá ®i, ta cã råi!/no")

end

function exchange_weapon()

	GiveItemUI( "Vò khİ ngò hµnh ®æi vò khİ kh¸c", "B¹n cÇn chuÈn bŞ vò khİ ngò hµnh ph©n biÖt cã Kim, Méc, Thñy, Háa, Thæ, chØ cÇn <color=blue>®Çy ®ñ ngò hµnh<color>, ®ång thêi ph¶i cã<color=blue> thuéc tİnh mµu xanh<color>, th× cã thÓ ®æi ®­îc mét vò khİ.<color=blue> §¼ng cÊp vò khİ vµ chñng lo¹i kh«ng cã h¹n chÕ, mçi lÇn nh­ vËy chØ tèn 10 v¹n l­îng, x¸c suÊt 100%.<color>", "weapon_ring_Confirm", "onCancel" );
...
--			Msg2Player("magictype = "..magictype)
			...
			Pay( onPay )
				--¹Ì¶¨µÄ½äÖ¸
			AddItem(0,random(0,1),random(0,2),random(8,10),random(0,4),random(100,200),random(5,10))     			--½äÖ¸
			Say("Uhm~®å cña ng­¬i ®· ®­îc x¸c ®Şnh, ta nhËn ®©y, vò khİ nµy lµ cña ng­¬i!",0)

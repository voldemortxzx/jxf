...
--		{30,1,{6,1,1606,1,0,0},1,"Viªm §Õ §å §»ng",1}			--ËéÆ¬
	...
	-- Thay ®æi phÇn th­ëng Boss cuèi tİnh n¨ng Viªm §Õ -Modifiled by DinhHQ - 20120314
	[4]=--×îÖÕboss
	{			
		...
		[10]={{szName="§å Phæ Kim ¤ Khİ Giíi",tbProp={6,1,2991,1,0,0},nCount=1,nRate=0.2},},
		...
		[16]={{szName="B¶o R­¬ng Kim ¤ Vò Khİ",tbProp={6,1,30190,1,0,0},nCount=1,tbParam={7,0,0,0,0,0},nRate=0.05, CallBack = _Message},},	
		...
		[22]={{szName="§å Phæ B¹ch Hæ Vò Khİ",tbProp={6,1,3182,1,0,0},nCount=1,nRate=0.1},},

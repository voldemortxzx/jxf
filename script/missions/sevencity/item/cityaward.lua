...
--	},
	...
	{szName = "MÆt n¹ Nguyªn so¸i",	tbProp = {0, 11, 447, 1, 0, 0}, nRate = 0.30},
	{szName = "B¸ch Niªn Tr©n Lé",		tbProp = {6, 1, 2266, 1, 0, 0}, nRate = 0.25},
	{szName = "V¹n Niªn Tr©n Lé",		tbProp = {6, 1, 2268, 1, 0, 0}, nRate = 0.52},
	{szName = "Thiªn Niªn Tr©n Lé",		tbProp = {6, 1, 2267, 1, 0, 0}, nRate = 0.31},	

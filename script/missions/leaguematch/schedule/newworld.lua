...
function OnNewWorld(szParam)
	...
	Msg2Player("<color=green>B¹n ®· vµo khu vùc chuÈn bÞ "..str_des..",thi ®Êu sÏ b¾t ®Çu sau <color=yellow>"..mm.."<color> phót n÷a")
	Msg2MSAll(WLLS_MSID_SCHEDULE, "<color=green>"..GetName().."<color> <color=yellow>®· vµo khu vùc chuÈn bÞ thi ®Êu "..str_des..".")

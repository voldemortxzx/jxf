...
function springfestival_aword(nTongID, nWorkshopID)
    ...
    local stryongshi = "Lµm rÊt tèt, ng­¬i ®· dïng ph¸o nÐm tróng niªn thó <color=yellow>"..nGetCount.."<color> lÇn, xÕp h¹ng thø <color=yellow>"..nRank.."<color>, ®©y lµ phÇn th­ëng dµnh cho ng­¬i, h·y nhËn lÊy!";

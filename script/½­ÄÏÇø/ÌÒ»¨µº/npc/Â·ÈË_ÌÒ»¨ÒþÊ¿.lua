...
function main()
	...
	if (nLevel < AEXP_NEEDLEVEL) then
		...
		Say("§µo Hoa ®¶o linh khİ sung m·n. Uèng thªm b¸t <color=red>ch¸o L¹p B¸t<color> sc«ng lùc sÏ t¨ng lªn rÊt nhiÒu. Mçi b¸t cã c«ng hiÖu trong 1 giê!",getn(tbSay),tbSay)
	end
end

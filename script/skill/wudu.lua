...
SKILLS={
	...
	binglan_xuanjing={ --±ùÀ¼Ðþ¾§
		coldres_p={{{1,-1},{20,-20},{21,-20}},{{1,18*20},{20,18*90}}},
	...
	jiutian_kuanglei={ --¾ÅÌì¿ñÀ×
		lightingres_p={{{1,-1},{20,-20},{21,-20}},{{1,18*20},{20,18*90}}},
	...
	chiyan_shitian={ --³àÑ×Ê´Ìì
		fireres_p={{{1,-1},{20,-20},{21,-20}},{{1,18*20},{20,18*90}}},
	...
	chuanxin_duci={ --´©ÐÄ¶¾´Ì
		poisonres_p={{{1,-1},{20,-20},{21,-20}},{{1,18*20},{20,18*90}}},
	...
	wudu_qijing={ --Îå¶¾Ææ¾­
		...
		lifemax_p={{{1,80},{20,80},{36,80}},{{1,-1},{30,-1}}},	--×î´óÉúÃüÖµ£¨Ñô£©¸ÄÎª80% 20160801
...
--		},
	...
	duanjin_fugu={ --¶Ï½î¸¯¹Ç
		allres_p={{{1,-1},{20,-15},{21,-15}},{{1,18*20},{20,18*90}}},
	...
	chuanyi_pojia={ --´©ÒÂÆÆ¼×
		physicsres_p={{{1,-1},{20,-20},{21,-20}},{{1,18*20},{20,18*90}}},

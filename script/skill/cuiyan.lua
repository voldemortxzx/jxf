...
--		skill_cost_v={{{1,24},{20,100}}}
	...
	binggu_xuexin={ --冰骨雪心
		...
		--addcoldmagic_v={{{1,60},{30,515}},{{1,-1},{2,-1}}},
		--addcolddamage_v={{{1,30},{30,375}},{{1,-1},{2,-1}}},
		--addphysicsmagic_v={{{1,30},{30,375}},{{1,-1},{2,-1}}},
		...
		lifemax_p={{{1,5},{30,10}},{{1,-1},{30,-1}}},
		fasthitrecover_v={{{1,5},{30,20}},{{1,-1},{30,-1}}},
	},

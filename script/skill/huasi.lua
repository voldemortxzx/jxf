...
SKILLS={
	...
	duoming_lianhuan={ --Doat Menh Lien Hoan Tam Kiem
		physicsenhance_p={{{1,75},{15,250},{20,350}}},
		seriesdamage_p={{{1,30},{15,60},{20,85},{21,95}}},
		colddamage_v={
			[1]={{1,200},{20,1050}},
			[3]={{1,250},{20,1150}}
		},
		deadlystrike_p={{{1,30},{20,65}}},
		skill_misslenum_v={{{1,1},{10,2},{15,3},{26,4}}},
		missle_speed_v={{{1,28},{20,32},{21,32}}},
		skill_attackradius={{{1,448},{20,512},{21,512}}},
		skill_cost_v={{{1,95},{20,155}}},

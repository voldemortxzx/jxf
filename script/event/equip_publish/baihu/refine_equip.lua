...
tbBaiHuRefineList = 
{
	...
	[7]= {szName="B¹ch Hæ Vò KhÝ", nStone = 1, nWidth = 2, nHeight = 4, },
...
--T¹m ®ãng tÝnh n¨ng chÕ t¹o B¹ch Hæ - Modified By DinhHQ - 20120511
--pEventType:Reg("Thî rÌn thÇn bÝ", "Ta muèn nhê «ng trïng luyÖn trang bÞ B¹ch Hæ", tbBaiHuRefineEquip.Dialog, {tbBaiHuRefineEquip})
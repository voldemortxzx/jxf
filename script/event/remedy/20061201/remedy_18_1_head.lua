...
2519, 
50, 
"18 khu 1 dõng ky duy tr× båi th­êng kinh nghiÖm "); 

function Remedy_20061031_Main() 
Say(" lÔ quan # ngµi mÊu chèt lÊy 12 nguyÖt ph©n 18 khu 1 dõng ky duy tr× båi th­êng kinh nghiÖm sao ? lÇn nµy kinh nghiÖm båi th­êng nhËn lÊy nhËt kú v× <color=yellow>2006 n¨m 12 th¸ng 1 ngµy tíi 2006 n¨m 12 th¸ng 07 ngµy , 50 cÊp trë lªn mçi ng­êi h¹n dÉn mét lÇn <color> . ", 
2, 
...
if nResult==1 then 
Say(" lÔ quan # ngµi ®· thµnh c«ng nhËn lÊy 18 khu 1 dõng ky duy tr× båi th­êng kinh nghiÖm , lo¹i nµy kinh nghiÖm lµ <color=yellow> th¨ng cÊp sau vÉn ®iÖp gia <color> ®İch , chóc ngµi h«m nay cã tèt vËn khİ . ", 0); 
return 1; 
else 

...
tab_jiefang_jieri2009 = {
	{455,1,1600,3203,0,"Minh NguyÖt l·o nh©n",0,"\\script\\event\\jiefang_jieri\\200904\\denggao\\npc.lua"},
}

tab_jiefang_jieri2008 = {
	{455,1,1600,3203,0,"Minh NguyÖt l·o nh©n",0,"\\script\\event\\jiefang_jieri\\200804\\xiaoyouxi\\saichanglaoban.lua"},
}
...
tab_zhongqiunpc_2007 = {
{212,1,1566,3150,0,"Thî b¸nh",0,"\\script\\event\\zhongqiu2007\\worker.lua"},
{212,1,1566,3257,0,"Thî b¸nh",0,"\\script\\event\\zhongqiu2007\\worker.lua"},
{212,1,1641,3153,0,"Thî b¸nh",0,"\\script\\event\\zhongqiu2007\\worker.lua"},
{212,1,1632,3262,0,"Thî b¸nh",0,"\\script\\event\\zhongqiu2007\\worker.lua"},
{625,1,1576,3146,0,"R­¬ng chøa ®å",0,"\\script\\event\\mid_autumn\\chuwuxiang.lua"},
{625,1,1573,3264,0,"R­¬ng chøa ®å",0,"\\script\\event\\mid_autumn\\chuwuxiang.lua"},
{625,1,1623,3262,0,"R­¬ng chøa ®å",0,"\\script\\event\\mid_autumn\\chuwuxiang.lua"},
{625,1,1647,3165,0,"R­¬ng chøa ®å",0,"\\script\\event\\mid_autumn\\chuwuxiang.lua"},
...
tab_newyear_2008 = {
{212,1,1566,3150,0,"Thî b¸nh",0,"\\script\\event\\newyear_2008\\zaozongbing\\worker.lua"},
{212,1,1566,3257,0,"Thî b¸nh",0,"\\script\\event\\newyear_2008\\zaozongbing\\worker.lua"},
{212,1,1641,3153,0,"Thî b¸nh",0,"\\script\\event\\newyear_2008\\zaozongbing\\worker.lua"},
{212,1,1632,3262,0,"Thî b¸nh",0,"\\script\\event\\newyear_2008\\zaozongbing\\worker.lua"},
{625,1,1576,3146,0,"R­¬ng chøa ®å",0,"\\script\\event\\mid_autumn\\chuwuxiang.lua"},
{625,1,1573,3264,0,"R­¬ng chøa ®å",0,"\\script\\event\\mid_autumn\\chuwuxiang.lua"},
{625,1,1623,3262,0,"R­¬ng chøa ®å",0,"\\script\\event\\mid_autumn\\chuwuxiang.lua"},
{625,1,1647,3165,0,"R­¬ng chøa ®å",0,"\\script\\event\\mid_autumn\\chuwuxiang.lua"},
...
function add_jiefang_jieri2009()
	add_jiefangnpc_jieri2009();
end

function add_jiefangnpc_jieri2009()
	for i= 520	, 526 do
		Mid =	SubWorldID2Idx(i);
		if (Mid >= 0) then
			for j = 1 , getn(tab_jiefang_jieri2009) do
				xpos = tab_jiefang_jieri2009[j][3] * 32
				ypos = tab_jiefang_jieri2009[j][4] * 32
				zhongqiu_index = AddNpc(tab_jiefang_jieri2009[j][1],tab_jiefang_jieri2009[j][2],Mid,xpos,ypos,tab_jiefang_jieri2009[j][5],tab_jiefang_jieri2009[j][6]);
				SetNpcScript(zhongqiu_index, tab_jiefang_jieri2009[j][8]);
			end
		end
	end
end

function add_jiefang_jieri2008()
	add_jiefangnpc_jieri2008();
end

function add_jiefangnpc_jieri2008()
	for i= 520	, 526 do
		Mid =	SubWorldID2Idx(i);
		if (Mid >= 0) then
			for j = 1 , getn(tab_jiefang_jieri2008) do
				xpos = tab_jiefang_jieri2008[j][3] * 32
				ypos = tab_jiefang_jieri2008[j][4] * 32
				zhongqiu_index = AddNpc(tab_jiefang_jieri2008[j][1],tab_jiefang_jieri2008[j][2],Mid,xpos,ypos,tab_jiefang_jieri2008[j][5],tab_jiefang_jieri2008[j][6]);
				SetNpcScript(zhongqiu_index, tab_jiefang_jieri2008[j][8]);
			end
		end
	end
end
...
function add_newyear_2008()
	add_newyearnpc_2008();
end

function add_newyearnpc_2008()
	for i= 520	, 526 do
		Mid =	SubWorldID2Idx(i);
		if (Mid >= 0) then
			for j = 1 , getn(tab_newyear_2008) do
				xpos = tab_newyear_2008[j][3] * 32
				ypos = tab_newyear_2008[j][4] * 32
				zhongqiu_index = AddNpc(tab_newyear_2008[j][1],tab_newyear_2008[j][2],Mid,xpos,ypos,tab_newyear_2008[j][5],tab_newyear_2008[j][6]);
				SetNpcScript(zhongqiu_index, tab_newyear_2008[j][8]);
			end
		end
	end
end

function add_zhongqiunpc_2007()
	add_mingyuenpc_2007();
end

function add_mingyuenpc_2007()
	for i= 520	, 526 do
		Mid =	SubWorldID2Idx(i);
		if (Mid >= 0) then
			for j = 1 , getn(tab_zhongqiunpc_2007) do
				xpos = tab_zhongqiunpc_2007[j][3] * 32
				ypos = tab_zhongqiunpc_2007[j][4] * 32
				zhongqiu_index = AddNpc(tab_zhongqiunpc_2007[j][1],tab_zhongqiunpc_2007[j][2],Mid,xpos,ypos,tab_zhongqiunpc_2007[j][5],tab_zhongqiunpc_2007[j][6]);
				SetNpcScript(zhongqiu_index, tab_zhongqiunpc_2007[j][8]);
			end
		end
	end
end

...
local nGoods = {"",0,0,0,0,0,0,0};
	...
	if (getn(decLinkAward)>0) then
		...
		if (nGoods[2]==1) then
			...
			AddGlobalCountNews("Ng­êi ch¬i <color=green>"..GetName().."<color> B¹n hoµn thµnh nhiÖm vô nµy <color=green>"..nTask.."<color> D· TÈu, nhËn ®­îc 1 bé Trang bŞ Hoµng Kim <color=yellow>"..nGoods[1].."<color> mét c¸i!!!", 3);

...
-- script viet hoa By http://tranhba.com  kiÕm hiÖp t×nh duyªn online t×nh nghÜa giang hå ®ång b¹n kŞch t×nh ch©n vèn thËt thÓ xö lı v¨n kiÖn - ch©u b¸u th­¬ng nh©n tu luyÖn thiªn 
...
PARID_REWIND_KILLER_01 = 39; -- script viet hoa By http://tranhba.com  nhÊt phÈm ®­êng th­¬ng binh 
PARID_REWIND_KILLER_02 = 40; -- script viet hoa By http://tranhba.com  nhÊt phÈm ®­êng cung binh 
PARID_REWIND_KILLER_03 = 41; -- script viet hoa By http://tranhba.com  nhÊt phÈm ®­êng ®eo ®ao t­íng l·nh 
PARID_REWIND_KILLER_04 = 42; -- script viet hoa By http://tranhba.com  vâ sÜ 
...
if GetRewindTaskState(PARID_TASK_REWIND_003)==nil then -- script viet hoa By http://tranhba.com  kh«ng cã mang ®ång b¹n 
return 0; 
elseif GetMasterTaskState(PARID_TASK_MASTER_003)<5 then -- script viet hoa By http://tranhba.com  ch­a hoµn thµnh kŞch t×nh thiªn ®İch nhiÖm vô 
return 4; 
elseif CheckRewindState(3)~=1 then -- script viet hoa By http://tranhba.com  kh«ng phï hîp nhËt kú ph¸n ®o¸n ®iÒu kiÖn 
return 5; 
elseif GetRewindTaskState(PARID_TASK_REWIND_003)==0 then -- script viet hoa By http://tranhba.com  lÇn ®Çu tiªn b¾t ®Çu lµm 
return 1; 
elseif GetRewindTaskState(PARID_TASK_REWIND_003)>=1 and GetRewindTaskState(PARID_TASK_REWIND_003)<5 then -- script viet hoa By http://tranhba.com  ®· b¾t ®Çu lµm 
return 2; 
elseif GetRewindTaskState(PARID_TASK_REWIND_003)==5 then -- script viet hoa By http://tranhba.com  ®· hoµn thµnh 
return 3; 
end; 
end, 
...
SelectDescribe({"<npc> nÕu nh­ t×m ®­îc ®inh lîi , cã lÏ cã thÓ tra ra chót ®Çu mèi . ng­¬i mang theo ngäc th¹ch ®i tr­íc khi an t×m b¶o khİ trai ®inh lîi , nÕu nh­ h¾n kh«ng cã ë ®©y , t×m ®Ö ®Ö cña h¾n ®inh lçi còng gièng nh­ nhau . ", 
" tiÕp nhËn nhiÖm vô /#rewindProcess_003_Accept:doTaskEntity()", 
...
" hoµn thµnh nhiÖm vô /#rewindProcess_003_Finish:doTaskEntity()", 
...
Msg2Player("Ng­¬i nhËn ®­îc ch©u b¸u th­¬ng nh©n ®ång b¹n tu luyÖn nhiÖm vô #"); 
...
" ®óng vËy , ta nguyÖn ı trî gióp ng­¬i ®i tö hµ lÜnh cøu ng­êi /#rewindProcess_003_Select01:doTaskEntity()", 
" c¸i nµy ®¬n gi¶n , ta gióp ng­¬i ra kia ba chôc triÖu hai ®İch tiÒn chuéc ®i /#rewindProcess_003_Select02:doTaskEntity()", 
...
" ta biÕt /#rewindProcess_003_SendMan:doTaskEntity()" 
}); 
...
" ®óng vËy , xin ®­a ta qu¸ khø ®i /#rewindProcess_003_Send:doTaskEntity()", 
...
" ®óng vËy , ®iÓm nµy tiÓu ı tø ng­¬i liÒn lÊy ®i ®i /#rewindProcess_003_Select02_01:doTaskEntity()", 
...
" rêi ®i tö hµ lÜnh /#rewindProcess_003_03_Send:doTaskEntity()", 
" kÕt thóc ®èi tho¹i /OnTaskExit"}); 
SetRewindTaskState(PARID_TASK_REWIND_003, 3); 
return 1; 
else 
SelectDescribe({"<npc> ai , nh÷ng thø nµy phØ ®å ®Òu lµ cïng hung cùc ¸c h¹ng ng­êi , hiÖp sÜ kh«ng cÇn lo ta , m×nh rêi ®i tr­íc ®i . ", 
" rêi ®i tö hµ lÜnh /#rewindProcess_003_03_Send:doTaskEntity()", 
" kÕt thóc ®èi tho¹i /OnTaskExit"}); 
return 0; 
end; 

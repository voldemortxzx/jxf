...
-- script viet hoa By http://tranhba.com  cuèi cïng t­ëng th­ëng kü n¨ng s¸ch ®İch ®Õm tæ 
ARY_AWARD_BOOKS = { 

-- script viet hoa By http://tranhba.com  kim hÖ 
[0] = {{839,"TrÊn ngôc xĞ trêi kİnh ","Kim hÖ ®ång b¹n v« th­îng t©m ph¸p , cã thÓ rót ng¾n chñ nh©n ®İch tróng ®éc thêi gian "}, 
{840,"§¹i bi nguyÒn rña ","Kim hÖ ®ång b¹n v« th­îng t©m ph¸p , cã thÓ gia t¨ng chñ nh©n ®İch ®éc phßng "}}, 

-- script viet hoa By http://tranhba.com  méc hÖ 
[1] = {{841, " luyÖn ngôc hñ cæ ","Méc hÖ ®ång b¹n v« th­îng t©m ph¸p , cã thÓ gia t¨ng chñ nh©n ®İch l«i phßng "}, 
...
[2] = {{843,"NghŞch chuyÓn t©m tr¶i qua ","Thñy hÖ ®ång b¹n v« th­îng t©m ph¸p , cã thÓ khiÕn cho chñ nh©n tèc ®é di ®éng nhanh h¬n "}, 
{844,"HuyÒn b¨ng ©m khİ ","Thñy hÖ ®ång b¹n v« th­îng t©m ph¸p , cã thÓ gia t¨ng chñ nh©n ®İch löa phßng "}}, 

-- script viet hoa By http://tranhba.com  háa hÖ 
[3] = {{845,"TrÇn v« İch ph¹m tÉn ","Háa hÖ ®ång b¹n v« th­îng t©m ph¸p , cã thÓ gia t¨ng chñ nh©n ®İch phæ phßng "}, 
...
{848,"V©n sinh kÕt h¶i ","Thæ hÖ ®ång b¹n v« th­îng t©m ph¸p , cã thÓ gia t¨ng chñ nh©n ®İch b¨ng phßng "}}, 

} 

-- script viet hoa By http://tranhba.com  tiÕn vµo B¸ch hoa cèc lóc ®İch ph¸n ®o¸n 
...
Say("Phİa tr­íc m©y mï l­în quanh , kiÕm khİ h­íng tiªu . tùa hå kh«ng ph¶i lµ ng­¬i b©y giê cã thÓ ®i ®İch ®Şa ph­¬ng . ",0); 
...
-- script viet hoa By http://tranhba.com  ®¹p ®Õn ®i ra ngoµi lóc ®İch ®iÓm ®İch xö lı 
...
taskEntity = function(self, nCondition) 
if nCondition==1 then 
SelectDescribe({"<npc> ng­¬i lµ thÕ nµo t×m tíi n¬i nµy tíi ? võa vµo giang hå , muèn thèi lui ra c¸nh nh­ vËy khã kh¨n sao ? Së mç ®êi nµy hÕt th¶y hÕt th¶y ®Òu bŞ c¸i nµy giang hå ®o¹t ®i liÔu , cßn kh«ng tháa m·n sao ? ®­îc råi , chØ cÇn ng­¬i kh«ng nãi ra ta chç Èn th©n , ta liÒn truyÒn cho ng­¬i kia tiÓu ®ång b¹n nhÊt thøc tuyÖt häc nh­ thÕ nµo ? bÊt qu¸ muèn häc Së mç ®İch vâ c«ng , kh«ng cã mét tèt trô cét , chØ biÕt tÈu háa nhËp ma , tù thiªu mµ chÕt . nÕu nh­ ng­¬i nhÊt ®Şnh ph¶i lµm cho tiÓu ®ång b¹n häc , tr­íc hÕt mang theo h¾n # nµng # hoµn thµnh { m­êi l¨m ngµy } ®İch { ®ång b¹n tu luyÖn nhiÖm vô } ®i . nhí , mçi ngµy ®İch nhiÖm vô ®Òu ph¶i toµn bé hoµn thµnh , kh«ng thÓ l­êi biÕng . ®Õn c«ng thµnh ngµy tíi t×m ta n÷a , ta liÒn ®em tuyÖt nghÖ dèc tói truyÒn cho . ", 
" tiÕp nhËn nhiÖm vô /#taskProcess_005_03:doTaskEntity()" 
}); 
elseif nCondition==2 then 
SelectDescribe({"<npc> ng­¬i ®· hoµn thµnh m­êi l¨m ngµy ®İch ®ång b¹n tu luyÖn nhiÖm vô sao ? ", 
" ta ®· hoµn thµnh /#taskProcess_005_Finish:doTaskEntity()", 
" t¹m thêi cßn kh«ng cã /OnTaskExit"}); 
elseif nCondition==4 then 
SelectDescribe({"<npc> nhí , khi ng­¬i ®İch ®ång b¹n ®Õn <color=yellow>80<color> cÊp lóc lµ ®­îc tíi t×m ta , ta liÒn ®em tuyÖt nghÖ dèc tói truyÒn cho . kh«ng thÓ l­êi biÕng . ", 
" kÕt thóc ®èi tho¹i /OnTaskExit" 
}); 
else 
SelectDescribe({"<npc> thiÕu niªn nghe m­a ca trªn lÇu , nÕn ®á bÊt tØnh la tr­íng . tr¸ng niªn nghe m­a kh¸ch chu trung , giang kho¸t v©n thÊp , ®o¹n nh¹n gäi giã t©y . mµ nay nghe m­a t¨ng l­ h¹ , tÊn ®· sao còng . bi hoan ly hîp tæng v« t×nh , mét ®¶m nhiÖm cÊp tr­íc ®iÓm tİch ®Õn trêi s¸ng . ", 
" kÕt thóc ®èi tho¹i /OnTaskExit" 
}); 
end; 
return 1; 
...
Msg2Player("Ng­¬i b©y giê cÇn mang ®ång b¹n cña ng­¬i hoµn thµnh 15 ngµy ®İch tu luyÖn nhiÖm vô #"); 
return 1; 
end, 
...
if nNum>=15 then 
SelectDescribe({"<npc> rÊt tèt , ng­¬i ®· hoµn thµnh m­êi l¨m ngµy ®İch ®ång b¹n tu luyÖn , ®©y lµ ®­a cho ng­¬i t­ëng th­ëng #", 
" nhËn lÊy t­ëng th­ëng /#taskProcess_005_AwardSelect:doTaskEntity()" 
}); 
return 1; 
else 
SelectDescribe({"<npc> ng­¬i cßn ch­a hoµn thµnh m­êi l¨m ngµy ®İch ®ång b¹n tu luyÖn nhiÖm vô ®i # ? ", 
" kÕt thóc ®èi tho¹i /OnTaskExit" 
}); 
return 1; 
end; 
...
-- script viet hoa By http://tranhba.com  nhËn lÊy Èn nóp nhiÖm vô t­ëng th­ëng , thiÕt trİ nhiÖm vô tiÕn tr×nh v× 2 
...
SelectDescribe({"<npc> ta chç nµy cã hai vèn kü n¨ng s¸ch thİch hîp ng­¬i b©y giê ®İch ®ång b¹n , ng­¬i muèn nhËn lÊy c¸i nµo kü n¨ng s¸ch t­ëng th­ëng ®©y ? <enter><enter><color=green>".. 
...
-- script viet hoa By http://tranhba.com  mçi ngµy sau khi hoµn thµnh mÖt mái thªm ®İch qu¸ tr×nh 
...
return 1; 
elseif nNum==15 then 
Msg2Player("Ng­¬i ®· hoµn thµnh m­êi l¨m ngµy ®İch ®ång b¹n tu luyÖn nhiÖm vô , ng­¬i b©y giê cã thÓ trë vÒ B¸ch hoa cèc ®i t×m kiÕm hoµng liÔu #"); 
return 1; 
end; 
end; 
return 0; 
...
-- script viet hoa By http://tranhba.com  cho ®ång b¹n ph¸t kü n¨ng s¸ch ®İch qu¸ tr×nh , nhiÖm vô tiÕn triÓn v× 2 

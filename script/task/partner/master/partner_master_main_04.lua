...
if GetMasterTaskState(PARID_TASK_MASTER_004)==nil then -- script viet hoa By http://tranhba.com  kh«ng cã mang ®ång b¹n 
return 0; 
elseif GetMasterTaskState(PARID_TASK_MASTER_004)==0 then -- script viet hoa By http://tranhba.com  lÇn ®Çu tiªn b¾t ®Çu lµm 
return 1; 
elseif GetMasterTaskState(PARID_TASK_MASTER_004)>=1 and GetMasterTaskState(PARID_TASK_MASTER_004)<3 then -- script viet hoa By http://tranhba.com  ®· b¾t ®Çu lµm 
return 2; 
elseif GetMasterTaskState(PARID_TASK_MASTER_004)>=3 then -- script viet hoa By http://tranhba.com  ®· hoµn thµnh 
return 3; 
end; 
end, 
...
SelectDescribe({"<npc> ta ®o¸n chõng ng­¬i chuyÕn nµy tÊt ®em cã ®iÒu thu ho¹ch , bÊt qu¸ cßn cÇn chuÈn bŞ s½n sµng a . ®Õn cèc trong t×m ®­îc c¸i ®ã gäi v­¬ng mét ®İch th­¬ng nh©n . ", 
" tiÕp nhËn nhiÖm vô /#taskProcess_004_Accept:doTaskEntity()", 
...
" xin ®­a ta ®i B¸ch hoa cèc ®i /#taskProcess_004_GotoWorld:doTaskEntity()", 
" hoµn thµnh nhiÖm vô /#taskProcess_004_Finish:doTaskEntity()", 
...
taskEntity = function(self, nCondition) 
SelectDescribe({"<npc> ng­¬i b©y giê muèn ®i B¸ch hoa cèc sao ? ta cã thÓ tiÔn ng­¬i mét ®o¹n ®­êng . ", 
" ®óng vËy , lµm phiÒn ng­¬i /#taskProcess_004_GotoWorld:doTaskEntity()", 
" ®Ó cho ta n÷a chuÈn bŞ mét chót ®i /OnTaskExit"}); 
Msg2Player("Ng­¬i nhËn ®­îc dŞ téc vâ sÜ ®İch ®ång b¹n kŞch t×nh nhiÖm vô #"); 
...
Msg2Player("Ng­¬i ®· hoµn thµnh dŞ téc vâ sÜ ®İch kŞch t×nh nhiÖm vô #"); 
...
" hay lµ tr­íc ®em ta ®­a trë vÒ ®i /#taskProcess_004_02_SendMan:doTaskEntity()", 
" kÕt thóc ®èi tho¹i /OnTaskExit"}); 
...
" ®óng vËy , xin ®­a ta ®i th«i /#taskProcess_004_02_Send:doTaskEntity()", 

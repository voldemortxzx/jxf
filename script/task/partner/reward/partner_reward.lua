...
IncludeLib( "FILESYS" ); 
IncludeLib("PARTNER") 
IncludeLib("TITLE") -- script viet hoa By http://tranhba.com  gia t¨ng danh hiÖu ®Çu v¨n kiÖn 
...
Include ("\\script\\task\\partner\\master\\partner_master_main_05.lua"); 					 -- script viet hoa By http://tranhba.com Ôö¼ÓÍ¬°éÒþ²ØÈÎÎñ¼ÇÂ¼ÌìÊýµÄÐèÇó
Include([[\script\tong\tong_award_head.lua]]);-- script viet hoa By http://tranhba.com  bang héi chu môc tiªu ®é cèng hiÕn by chÝ s¬n 
TITLETIME = 30 * 24 * 60 * 60 * 18 * 36 -- script viet hoa By http://tranhba.com  danh hiÖu kü n¨ng ®Ých thi hµnh thêi gian 
...
nt_setTask(1246,5) -- script viet hoa By http://tranhba.com  lÇn ®Çu tiªn khëi ®éng nhiÖm vô lóc , ®em ®ång b¹n mçi ngµy cho phÐp hoµn thµnh sè lÇn thiÕt v× 5 
...
if ( Uworld1241 >= 5 ) then -- script viet hoa By http://tranhba.com  tu luyÖn nhiÖm vô sè lÇn ®· ®¹t tíi th­îng h¹n 
...
nt_setTask(1245,2) 
Msg2Player("Chóc mõng ng­¬i thu ®­îc thanh long vâ sÜ ®Ých danh hiÖu #") 
...
nt_setTask(1245,3) 
Msg2Player("Chóc mõng ng­¬i thu ®­îc Thanh Long kiÕm s¸t ®Ých danh hiÖu #") 
...
nt_setTask(1245,4) 
nt_setTask(1246,10) -- script viet hoa By http://tranhba.com  gia t¨ng mçi ngµy nh­ng hoµn thµnh tu luyÖn nhiÖm vô sè lÇn v× 10 lÇn # 
Msg2Player("Chóc mõng ng­¬i thu ®­îc thanh long vò tuyÖt ®Ých danh hiÖu # mçi ngµy cho phÐp hoµn thµnh tu luyÖn nhiÖm vô sè lÇn bÞ gia t¨ng ®Õn 10 lÇn #") 

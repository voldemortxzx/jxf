...
if ( Uworld1241 >= 10 ) then -- script viet hoa By http://tranhba.com  tu luyÖn nhiÖm vô sè lÇn ®· ®¹t tíi th­îng h¹n 
...
return 1 
elseif ( PARTNER_GetTaskValue(partnerindex, 2) == 0 ) then -- script viet hoa By http://tranhba.com  h«m nay ®· lµm tu luyÖn nhiÖm vô sè lÇn kh«ng v× 0 
local j = 0 
for i =1,NpcCount do 
...
nt_setTask(1245,5) 
nt_setTask(1246,20) 
Msg2Player("Chóc mõng ng­¬i thu ®­îc long thÇn chi kiÕm danh hiÖu # mçi ngµy tu luyÖn nhiÖm vô cho phÐp hoµn thµnh sè lÇn gia t¨ng ®Õn 20 lÇn #") 

...
tbConfig[2] = --Ò»¸öÏ¸½Ú
{
	...
	nStartDate = nil,
	nEndDate  = nil,
	tbMessageParam = {"'HiÖp Chi §¹i Gi¶, V× N­íc V× D©n'. LÇn nµy ta phông mÖnh s­ phô, ®Õn ®©y ®Ó t×m c¸c ch­ vÞ anh hïng hµo kiÖt. S­ phô ta nãi r»ng chØ cÇn chóng ta ®ång t©m hiÖp lùc, ¾t sÏ cã 1 ngµy sÏ ®¸nh ®uæi ®­îc Th¸t Tö. Noµ ng­¬i cã ph¶i lµ ng­êi mµ ta muèn t×m kh«ng?",0},
	tbCondition = 
	{
		{"ThisActivity:IsOpen",	{nil} },
	},

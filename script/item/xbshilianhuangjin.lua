-- script viet hoa By http://tranhba.com  thö luyÖn bİ b¶o # hoµng kim # 
...
for i=1,num do 
p=random(1,14); 
if(p == 1)then -- script viet hoa By http://tranhba.com  tö m·ng lµm 
AddItem(6,1,2350,1,0,0,0) 
...
elseif(p == 9)then -- script viet hoa By http://tranhba.com  cöu thiªn d¹o ch¬i ®an 

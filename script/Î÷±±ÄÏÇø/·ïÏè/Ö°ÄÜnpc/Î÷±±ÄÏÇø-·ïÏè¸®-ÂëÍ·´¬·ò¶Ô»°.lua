...
Include("\\script\\activitysys\\config\\12\\extend.lua")	--activitysys/config/12

---------------------------------------------------------------
function main(sel)
	if (GetLevel() >= 50) then
		Say("Hoµng hµ chÝn khóc uèn quanh, em bê bªn Êy cßn anh bªn nµy....", 3, "Ngåi thuyÒn/WharfFun", "Kh«ng ngåi/OnCancel", "vantieu/vantieu", "§i §µo Hoa ®¶o (7) /go_thd");
	else
